            ...
            >
                ...
                >
                    ...
                    <p className="mx-auto max-w-2xl text-sm leading-relaxed text-zinc-200 sm:text-base">
                        Estamos prontos para receber você com estilo e cuidado
                        nos detalhes.
                    </p>
                </motion.div>
                ...
                <div className="grid gap-6 md:grid-cols-[0.8fr_1.2fr]">
                    ...
                    >
                        <div className="space-y-6">
                            <div>
                                ...
                                <a
                                    ...
                                    className="block text-xs leading-relaxed text-zinc-200 transition hover:text-[#A2E317] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A2E317] focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                                >
                            ...
                            <div>
                                ...
                                <div className="space-y-3 text-xs text-zinc-200">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center gap-2 transition hover:text-[#A2E317] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A2E317] focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                                    >
                                        <span className="bg-white/5 px-1.5 py-0.5 text-[9px] font-bold uppercase tracking-widest text-white">
                                            WhatsApp:
                                        </span>
                            ...
                            <div>
                                ...
                                <div className="space-y-1.5 text-xs text-zinc-200">
                                    ...
                                    <p className="flex justify-between italic text-zinc-300">
                                        <span>Domingo:</span>
                        ...
                        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                            <motion.a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex flex-1 items-center justify-center gap-2 bg-[#A2E317] py-3 text-[10px] font-black uppercase tracking-widest text-black transition hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                                style={{
                                    clipPath:
                            ...
                            <motion.a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex flex-1 items-center justify-center border border-white/20 bg-transparent py-3 text-[10px] font-black uppercase tracking-widest text-white transition hover:bg-white hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A2E317] focus-visible:ring-offset-2 focus-visible:ring-offset-black"
                                style={{
                                    clipPath:
                                        "polygon(10% 0, 100% 0, 100% 70%, 90% 100%, 0 100%, 0 30%)",
                                }}
                    ...
                    >
                        ...
                        <iframe
                            ...
                            className="absolute inset-0 block h-full w-full border-0 grayscale invert-[0.9] contrast-[1.2] opacity-70 transition-all duration-700 group-hover:grayscale-0 group-hover:invert-0 group-hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A2E317]"
                            loading="lazy"
